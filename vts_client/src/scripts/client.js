...
// const signalingServerPort = 18088 // must be the same to server.js PORT
// const signalingServer = getSignalingServer()
// const roomId = getRoomId()
// const peerRole = getPeerRole()
...
//  */
// export function getHtmlElementsById() {
...
//  */
// export function setButtonsToolTip() {
//   // not need for mobile
...
//   setTippy(
//     msgerVideoUrlBtn,
//     'Share YouTube video to all participants',
//     'right-start',
//   )
// }
...
//  * @param {*} placement
//  */
// export function setTippy(elem, content, placement) {
//   tippy(elem, {
//     content: content,
//     placement: placement,
//   })
...
//  * @returns json
//  */
// export function getPeerGeoLocation() {
...
//  */
// export function thereIsPeerConnections() {
 ...
 */
export function initClientPeer(socket) {
...
//  */
// export async function sendToServer(msg, config = {}) {
...
//  */
// export async function sendToDataChannel(config) {
//   if (
...
//  */
// export function checkPeerAudioVideo() {
//   let qs = new URLSearchParams(window.location.search)
...
//  * @param {*} config
//  */
// export function handleAddPeer(config) {
...
//   console.log('-------- client 쪽 rtc instance 확인')
//   console.log(peer_id)
//   console.log(peerConnections)

//   handlePeersConnectionStatus(peer_id) // 이것은 caller의 입장에서 필요 없음. callee랑 뭔가 통신 하는 부분이 아님.
//   msgerAddPeers(peers) // 이 부분은 caller와 callee의 채팅에 관련되어 있는 것인데 현재는 필요가 없는 부분이지.
//   handleOnIceCandidate(peer_id) // 이 부분은 조금 중요한 부분인데 ICE Candidate를 add하는 부분이지. 그런데 이것은 stream 생성 완료하고 track에 add된 다음에 negotiationneeded실행 된 다음 video offer를 보낼 때 필요
...
//  */
// export function handlePeersConnectionStatus(peer_id) {
...
//  * @param {*} peer_id
//  */
// export function handleOnIceCandidate(peer_id) {
...
//  * @param {*} peers
//  */
// export function handleOnTrack(peer_id, peers) {
...
//  * @param {*} peer_id
//  */
// export function handleAddTracks(peer_id) {
...
//  * @param {*} peer_id
//  */
// export function handleRTCDataChannels(peer_id) {
...
//  * @param {*} peer_id
//  */
// export function handleRtcOffer(peer_id) {
//   console.log('true인 경우에는 무조건 불려야 한다. 즉, caller는 true이다.')
...
//  * @param {*} config
//  */
// export function handleSessionDescription(config) {
...
//  * @param {*} config
//  */
// export function handleIceCandidate(config) {
//   let peer_id = config.peer_id
//   let ice_candidate = config.ice_candidate
//   console.log(peer_id)
//   console.log(ice_candidate)
//   console.log('이건 client에서 보내는 것. ice_candidate가 없어야 하지 않을까?')
...
//  * @param {*} config
//  */
// export function handleRemovePeer(config) {
...
//  */
// export function setButtonsBarPosition(position) {
...
//  * @param {*} stream
//  */
// export function loadLocalMedia(stream) {
...
//  * @param {*} peer_id
//  */
// export function loadRemoteMediaStream(stream, peers, peer_id) {
...
//  * @param {*} stream
//  */
// export function logStreamSettingsInfo(name, stream) {
//   console.log(name, {
//     video: {
...
//  * @param {*} peerName
//  */
// export function setPeerAvatarImgName(videoAvatarImageId, peerName) {
...
//  */
// export function setPeerChatAvatarImgName(avatar, peerName) {
//   let avatarImg =
//     avatarApiUrl +
//     '?name=' +
//     peerName +
...
//  * @param {*} peer_id
//  */
// export function handleVideoPlayerFs(
//   videoId,
//   videoFullScreenBtnId,
//   peer_id = null,
// ) {
...
//  * @param {*} peer_id
//  */
// export function handleVideoToImg(videoStream, videoToImgBtn, peer_id = null) {
...
//  */
// export function manageLeftButtons() {
//   setShareRoomBtn()
//   setAudioBtn()
//   setVideoBtn()
//   setSwapCameraBtn()
...
//  */
// export function setShareRoomBtn() {
...
//  */
// export function setSwapCameraBtn() {
...
//  */
// export function setScreenShareBtn() {
//   if (
//     !isMobileDevice &&
...
//  */
// export function setRecordStreamBtn() {
...
//  */
// export function setFullScreenBtn() {
...
//  */
// export function setChatRoomBtn() {
...
//   // Execute a export function when the user releases a key on the keyboard
...
//  */
// export function setCaptionRoomBtn() {
...
//  */
// export function setChatEmojiBtn() {
...
//  */
// export function setMyWhiteboardBtn() {
...
//  */
// export function setMyFileShareBtn() {
...
//  */
// export function setMySettingsBtn() {
...
//  */
// export function setLeaveRoomBtn() {
...
//  */
// export function handleBodyOnMouseMove() {
...
//  */
// export function setupMySettings() {
//   // tab buttons
...
//  */
// export function setupVideoUrlPlayer() {
//   if (isMobileDevice) {
...
//  * @returns constraints
//  */
// export function getAudioVideoConstraints() {
...
//  * @param {*} maxFrameRate
//  */
// export function setLocalMaxFps(maxFrameRate) {
//   localMediaStream
//     .getVideoTracks()[0]
...
//  * https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/applyConstraints
//  */
// export function setLocalVideoQuality() {
//   let videoConstraints = getVideoConstraints(
//     videoQualitySelect.value ? videoQualitySelect.value : 'default',
//   )
//   localMediaStream
...
//  */
// export function showButtonsBarAndMenu() {
//   if (
//     isButtonsVisible ||
...
//  */
// export async function shareRoomUrl() {
//   const myRoomUrl = window.location.href
...
//  */
// export function shareRoomByEmail(message) {
...
//  */
// export function handleAudio(e, init, force = null) {
...
//       setTippy(
//         initAudioBtn,
//         myAudioStatus ? 'Click Audio OFF' : 'Click Audio ON',
//         'top',
//       )
//     }
//   }
...
//  * @param {*} init bool true/false
//  */
// export function handleVideo(e, init, force = null) {
...
//       setTippy(
//         initVideoBtn,
//         myVideoStatus ? 'Click Video OFF' : 'Click Video ON',
//         'top',
//       )
//     }
//   }
...
//  */
// export function stopLocalVideoTrack() {
...
//  */
// export function stopLocalAudioTrack() {
...
//  * @param {*} status
//  */
// export function setScreenSharingStatus(status) {
...
//  */
// export function setMyVideoStatusTrue() {
...
//  */
// export function refreshMyStreamToPeers(stream, localAudioTrackChange = false) {
...
//  * @param {*} localAudioTrackChange true or false(default)
//  */
// export function refreshMyLocalStream(stream, localAudioTrackChange = false) {
...
//  */
// export function startRecordingTime() {
...
//  */
// export function notifyRecording(from, action) {
...
//  * @param {*} mediaRecorder
//  */
// export function handleMediaRecorder(mediaRecorder) {
//   mediaRecorder.start()
...
//  * @param {*} event
//  */
// export function handleMediaRecorderStart(event) {
//   playSound('recStart')
//   if (isRecScreenSream) {
...
//  * @param {*} event
//  */
// export function handleMediaRecorderData(event) {
...
//  * @param {*} event
//  */
// export function handleMediaRecorderStop(event) {
//   playSound('recStop')
...
//  * Stop recording
//  */
// export function stopStreamRecording() {
//   mediaRecorder.stop()
// }
...
//  */
// export function setRecordButtonUi() {
...
//  */
// export function downloadRecordedStream() {
//   try {
...
//  * @param {*} peer_id
//  */
// export function createChatDataChannel(peer_id) {
...
//  */
// export function setChatRoomAndCaptionForMobile() {
//   if (isMobileDevice) {
...
//  */
// export function showChatRoomDraggable() {
//   playSound('newMessage')
//   if (isMobileDevice) {
//     buttonsBar.style.display = 'none'
//     isButtonsVisible = false
...
//  */
// export function showCaptionDraggable() {
//   playSound('newMessage')
//   if (isMobileDevice) {
//     buttonsBar.style.display = 'none'
//     isButtonsVisible = false
...
//  */
// export function hideChatRoomAndEmojiPicker() {
...
//  * Hide chat room and emoji picker
//  */
// export function hideCaptionBox() {
...
//  * @param {*} dataMessage
//  */
// export function handleDataChannelChat(dataMessage) {
...
//  * @param {*} config
//  */
// export function handleDataChannelSpeechTranscript(config) {
...
//  * @param {*} data
//  */
// export function handleSpeechTranscript(config) {
//   if (!config) return
...
//  * @param {*} privateMsg
//  */
// export function appendMessage(from, img, side, msg, privateMsg) {
...
//  * @param {*} peers
//  */
// export function msgerAddPeers(peers) {
...
//  * @param {*} peer_id
//  */
// export function msgerRemovePeer(peer_id) {
...
//  */
// export function addMsgerPrivateBtn(msgerPrivateBtn, msgerPrivateMsgInput) {
...
//  */
// export function emitMsg(from, to, msg, privateMsg) {
//   if (!msg) return
...
//  */
// export function hideShowEmojiPicker() {
...
//  */
// export function downloadChatMsgs() {
...
//  */
// export function hideShowMySettings() {
...
//  */
// export function updateMyPeerName() {
...
//  * @param {*} config
//  */
// export function handlePeerName(config) {
//   let peer_id = config.peer_id
...
//  * @param {*} status
//  */
// export function emitPeerStatus(element, status) {
...
//  */
// export function setMyHandStatus() {
//   if (myHandStatus) {
//     // Raise hand
//     myHandStatus = false
//     if (!isMobileDevice) {
...
//  * @param {*} status
//  */
// export function setMyAudioStatus(status) {
...
//     setTippy(
//       audioBtn,
//       status ? 'Click Audio OFF' : 'Click Audio ON',
//       'right-start',
//     )
//   }
// }
...
//  * @param {*} status
//  */
// export function setMyVideoStatus(status) {
...
//     setTippy(
//       videoBtn,
//       status ? 'Click Video OFF' : 'Click Video ON',
//       'right-start',
//     )
//   }
// }
...
//  * @param {*} config
//  */
// export function handlePeerStatus(config) {
//   //
//   let peer_id = config.peer_id
//   let peer_name = config.peer_name
...
//  * @param {*} status
//  */
// export function setPeerHandStatus(peer_id, peer_name, status) {
...
//  * @param {*} status
//  */
// export function setPeerAudioStatus(peer_id, status) {
...
//  * @param {*} peer_id
//  */
// export function handlePeerAudioBtn(peer_id) {
...
//  * @param {*} peer_id
//  */
// export function handlePeerVideoBtn(peer_id) {
...
//  * @param {*} toPeerName
//  */
// export function handlePeerPrivateMsg(peer_id, toPeerName) {
...
//  * @param {*} peer_id
//  */
// export function handlePeerYouTube(peer_id) {
...
//  * @param {*} status
//  */
// export function setPeerVideoStatus(peer_id, status) {
...
//  */
// export function emitPeersAction(peerAction) {
//   if (!thereIsPeerConnections()) return
...
//  * @param {*} peerAction
//  */
// export function emitPeerAction(peer_id, peerAction) {
//   if (!thereIsPeerConnections()) return
...
//  * @param {*} config
//  */
// export function handlePeerAction(config) {
//   let peer_name = config.peer_name
...
//  */
// export function setMyAudioOff(peer_name) {
...
//  */
// export function setMyVideoOff(peer_name) {
...
//  */
// export function disableAllPeers(element) {
//   if (!thereIsPeerConnections()) {
//     userLog('info', 'No participants detected')
//     return
//   }
...
//  * @param {*} element audio/video
//  */
// export function disablePeer(peer_id, element) {
//   if (!thereIsPeerConnections()) {
//     userLog('info', 'No participants detected')
//     return
//   }
...
//  */
// export function lockUnlockRoom() {
...
//  */
// export function emitRoomStatus() {
...
//  * @param {*} config
//  */
// export function handleRoomStatus(config) {
//   let peer_name = config.peer_name
...
//  */
// export function handleRoomLocked() {
//   playSound('kickedOut')
...
//  */
// export function handleWhiteboardToggle() {
//   thereIsPeerConnections()
...
//  */
// export function setupWhiteboardCanvas() {
...
//  */
// export function setupWhiteboardCanvasSize() {
...
//  * @param {*} h height
//  */
// export function setWhiteboardSize(w, h) {
...
//  */
// export function whiteboardIsDrawingMode(status) {
...
//  * @param {*} status true or false
//  */
// export function whiteboardIsEraser(status) {
//   whiteboardIsDrawingMode(false)
//   wbIsEraser = status
...
//  * @param {*} type object
//  */
// export function whiteboardAddObj(type) {
//   switch (type) {
//     case 'imgUrl':
//       Swal.fire({
//         background: swalBackground,
...
//  * @param {*} obj
//  */
// export function addWbCanvasObj(obj) {
//   if (obj) {
//     wbCanvas.add(obj)
//     whiteboardIsDrawingMode(false)
//     wbCanvasToJson()
...
//  */
// export function setupWhiteboardLocalListners() {
...
//  * @param {*} color
//  */
// export function wbCanvasBackgroundColor(color) {
...
//  */
// export function wbCanvasSaveImg() {
...
//  * @param {*} fileName
//  */
// export function saveDataToFile(dataURL, fileName) {
...
//  */
// export function wbCanvasToJson() {
//   if (thereIsPeerConnections()) {
//     let config = {
//       room_id: roomId,
...
//  * @param {*} config
//  */
// export function handleJsonToWbCanvas(config) {
...
//  * @returns json
//  */
// export function getWhiteboardAction(action) {
//   return {
//     room_id: roomId,
//     peer_name: myPeerName,
//     action: action,
...
//  */
// export function confirmCleanBoard() {
//   playSound('newMessage')
...
//  * @param {*} config
//  */
// export function whiteboardAction(config) {
//   if (thereIsPeerConnections()) {
...
//  * @param {*} logme
//  */
// export function handleWhiteboardAction(config, logme = true) {
//   if (logme) {
...
//  * @param {*} peer_id
//  */
// export function createFileSharingDataChannel(peer_id) {
...
//  * @param {*} data
//  */
// export function handleDataChannelFileSharing(data) {
...
//  */
// export function sendFSData(data) {
...
//  */
// export function handleFileAbort() {
//   receiveBuffer = []
//   incomingFileData = []
//   receivedSize = 0
...
//  */
// export function hideFileTransfer() {
//   receiveFileDiv.style.display = 'none'
// }
...
//  */
// export function selectFileToShare() {
//   playSound('newMessage')
...
//  * @param {*} config file
//  */
// export function handleFileInfo(config) {
...
//  * @param {*} file
//  */
// export function saveBlobToFile(blob, file) {
...
//  *
//  */
// export function sendVideoUrl(peer_id = null) {
//   playSound('newMessage')
...
//  * Open video url Player
//  */
// export function openVideoUrlPlayer(config) {
...
//  */
// export function closeVideoUrlPlayer() {
...
//  * @param {*} config
//  */
// export function emitVideoPlayer(video_action, config = {}) {
...
//  * @param {*} config
//  */
// export function handleVideoPlayer(config) {
//   let peer_name = config.peer_name
...
//  * @param {*} peer_id
//  */
// export function handlePeerKickOutBtn(peer_id) {
...
//  */
// export function kickOut(peer_id, peerKickOutBtn) {
...
//  * @param {*} config
//  */
// export function handleKickedOut(config) {
//   let peer_name = config.peer_name
...
//  * @param {*} dragObj
//  */
// export function dragElement(elmnt, dragObj) {
//   let pos1 = 0,
//     pos2 = 0,
//     pos3 = 0,
//     pos4 = 0
...
//  */
// export function handlePeerVolume(data) {
...
//  */
// export function handleMyVolume(data) {
...
//  * @param {*} displayState
//  */
// export function toggleClassElements(className, displayState) {
...
//  * @param {*} className
//  */
// export function getEcN(className) {
